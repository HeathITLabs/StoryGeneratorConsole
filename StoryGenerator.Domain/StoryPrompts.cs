namespace StoryGenerator.Core.Constants
{
    public static class StoryPrompts
    {
        public const string PreamblePrompt = @"
...
completed their ""primary objective"", then end the story.";
        ...
        public static string DescriptionPrompt(string userInput) => $@"You are helping someone create the background of a story based on all of the 
...
IMPORTANT: Do not include any reasoning, thinking, or explanation. Return ONLY the JSON object with no additional text, markdown formatting, or thinking tags.";
        ...
        public static string BeginStoryPrompt(string description) => $@"
...
Split the story into 3 parts of similar length.
...
{{
    ...
    ""choices"": [
        {{
            ""choice"": ""choice 1"",
            ""story"": ""Story narrative for choice 1"",
            ""rating"": ""GOOD""
        }},
        {{
            ""choice"": ""choice 2"",
            ""story"": ""Story narrative for choice 2"",
            ""rating"": ""BAD""
        }},
        {{
            ""choice"": ""choice 3"",
            ""story"": ""Story narrative for choice 3"",
            ""rating"": ""NEUTRAL""
        }},
        {{
            ""choice"": ""choice 4"",
            ""story"": ""Story narrative for choice 4"",
            ""rating"": ""GOOD""
        }},
        {{
            ""choice"": ""choice 5"",
            ""story"": ""Story narrative for choice 5"",
            ""rating"": ""NEUTRAL""
        }}
    ]
}}
...
Do not use any harmful expressions, hate speech, or vulgar language.";
        ...
        public static string ContinuePrompt(string choice, string currentMilestone) => $@"
...
in the next part of the story. Split the story into 3 parts of
similar length.
...
Do not use any harmful expressions, hate speech, or vulgar language.";
        ...
        private const string ChoicesPrompt = @"   
...
based on whether the choice is good, bad, or neutral.";
        ...
        public static string CreateImagePrompt(string story) => $@"Create a stylized graphic novel illustration of {story}.
